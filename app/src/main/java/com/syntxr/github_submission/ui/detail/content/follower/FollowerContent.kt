package com.syntxr.github_submission.ui.detail.content.follower
        ...
        when (followerState) {
            is DetailState.Error -> {
                LaunchedEffect(key1 = true) {
                    snackBarHostState.showSnackbar(followerState.message)
                }
            }
            ...
            is DetailState.Success<*> -> {
                val follower = followerState.data as UserResponse
                LazyColumn(
                    modifier = Modifier
                        .fillMaxSize()
                        .padding(it)
